...
class Setting : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Update button texts with string resources
        ...
        // === Load User Info (Correctly from user_prefs) ===
        val prefs = getSharedPreferences("user_prefs", Context.MODE_PRIVATE)
        val email = prefs.getString("lastUserEmail", "guest@example.com")

// Handle long emails properly

        userEmail.text = email

// Enable smooth scrolling (marquee) if needed
        ...
        paymentMethodsButton.setOnClickListener {
            Toast.makeText(this, getString(R.string.payment_methods), Toast.LENGTH_SHORT).show()
        }
